...
x = np.concatenate((train_temp, train3), axis=0)

df1 = pandas.DataFrame(x)

#print "non rotated training data : ", df1.shape
...
#print " non rotated test data : ", df3.shape
...
df_train = pandas.concat([df1, df2])
df_train.index = range(len(df_train))

#print " training data set (df_train) appended with respective rotated versions ", df_train.shape
...
def RandomForest_cross_validation(X_train, y_train, X_test, y_test, y_test_nr, X_test_nr):
    ...
    print "Training time for the rotated test data  :", time_train 
    #print "--------------------------------------------------------"
    #print "--------------------------------------------------------"    
    ...
    print "--------------------------------------------------------"
    print "--------------------------------------------------------"
    print "Test score for non rotated test data: ", test_score_nr
    print "Test time nr : ", time_test_nr
    print "--------------------------------------------------------"
    print "--------------------------------------------------------"
    print "Confusion matrix for non rotated test data: "
    print cm_nr
    print "--------------------------------------------------------"
    print "--------------------------------------------------------"
